...
check('主应用文件存在且为当前版本', html.includes('版本 v19.01 · 模型分档与免费接入引导'), appFile);
...
check('版本规则从 v19 起每 20 次改动进一位已记录在计划书', html.includes('版本 v19.01 · 模型分档与免费接入引导') && fs.readFileSync(path.join(root,'docs','个人本地PRD输出助手_优化实施计划.md'),'utf8').includes('v19.01–v19.19'));
